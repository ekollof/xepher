...
int command__affiliation(COMMAND_ARGS);
int command__voice(COMMAND_ARGS);
int command__devoice(COMMAND_ARGS);
int command__op(COMMAND_ARGS);
int command__deop(COMMAND_ARGS);
int command__mucregister(COMMAND_ARGS);
